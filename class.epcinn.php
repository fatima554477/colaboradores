...
/**//**//**//**//*TARJETA DE CREDITO EMPRESARIAL*//**//**//**//**/
	...
	public function variablesTempresarial(){
		$conn = $this->db();
	...
	public function guardarTempresarial(  $FECHA_ENTREGA_TARJETA , $FECHA_DEVOLUCION_TARJETA , $TTARJETA , $TBANCO , $T_TIPO_TARJETA , $T_NUMERO_TARJETA , $T_FECHA_VENCIMIENTO , $T_CODIGO_SEGURIDAD , $T_LIMITE_CREDITO , $T_FECHA_CORTE , $T_FECHA_LIMITE , $T_NIP , $T_USUARIO , $T_CONTRASENA , $T_TELEFONO_EXTRAVIO , $T_DIRECCION_COMPLETA , $T_TELEFONO_TARJETA , $T_CORREO_ALTA , $T_FECHA_BAJA , $T_NUMERO_REPORTE , $T_NOMBRE_OPERADOR , $T_OBSERVACIONES_1 , $T_OBSERVACIONES_2, $ITEMPRESARIAL2, $IpTEMPRESARIAL){
		$conn = $this->db();
		$existe = $this->revisar_Tempresarial();
		$session = isset($_SESSION['id'])?$_SESSION['id']:'';
		if($session != ''){
			
		$var1 = "update 01Tempresarial set FECHA_ENTREGA_TARJETA = '".$FECHA_ENTREGA_TARJETA."' , FECHA_DEVOLUCION_TARJETA = '".$FECHA_DEVOLUCION_TARJETA."' , TTARJETA = '".$TTARJETA."' , TBANCO = '".$TBANCO."' , T_TIPO_TARJETA = '".$T_TIPO_TARJETA."' , T_NUMERO_TARJETA = '".$T_NUMERO_TARJETA."' , T_FECHA_VENCIMIENTO = '".$T_FECHA_VENCIMIENTO."' , T_CODIGO_SEGURIDAD = '".$T_CODIGO_SEGURIDAD."' , T_LIMITE_CREDITO = '".$T_LIMITE_CREDITO."' , T_FECHA_CORTE = '".$T_FECHA_CORTE."' , T_FECHA_LIMITE = '".$T_FECHA_LIMITE."' , T_NIP = '".$T_NIP."' , T_USUARIO = '".$T_USUARIO."' , T_CONTRASENA = '".$T_CONTRASENA."' , T_TELEFONO_EXTRAVIO = '".$T_TELEFONO_EXTRAVIO."' , T_DIRECCION_COMPLETA = '".$T_DIRECCION_COMPLETA."' , T_TELEFONO_TARJETA = '".$T_TELEFONO_TARJETA."' , T_CORREO_ALTA = '".$T_CORREO_ALTA."' , T_FECHA_BAJA = '".$T_FECHA_BAJA."' , T_NUMERO_REPORTE = '".$T_NUMERO_REPORTE."' , T_NOMBRE_OPERADOR = '".$T_NOMBRE_OPERADOR."' , T_OBSERVACIONES_1 = '".$T_OBSERVACIONES_1."' , T_OBSERVACIONES_2 = '".$T_OBSERVACIONES_2."' where id = '".$IpTEMPRESARIAL."' ; ";
		
		$var2 = "insert into 01Tempresarial ( FECHA_ENTREGA_TARJETA, FECHA_DEVOLUCION_TARJETA, TTARJETA, TBANCO, T_TIPO_TARJETA, T_NUMERO_TARJETA, T_FECHA_VENCIMIENTO, T_CODIGO_SEGURIDAD, T_LIMITE_CREDITO, T_FECHA_CORTE, T_FECHA_LIMITE, T_NIP, T_USUARIO, T_CONTRASENA, T_TELEFONO_EXTRAVIO, T_DIRECCION_COMPLETA, T_TELEFONO_TARJETA, T_CORREO_ALTA, T_FECHA_BAJA, T_NUMERO_REPORTE, T_NOMBRE_OPERADOR, T_OBSERVACIONES_1, T_OBSERVACIONES_2,  idRelacion) values ( '".$FECHA_ENTREGA_TARJETA."' , '".$FECHA_DEVOLUCION_TARJETA."' , '".$TTARJETA."' , '".$TBANCO."' , '".$T_TIPO_TARJETA."' , '".$T_NUMERO_TARJETA."' , '".$T_FECHA_VENCIMIENTO."' , '".$T_CODIGO_SEGURIDAD."' , '".$T_LIMITE_CREDITO."' , '".$T_FECHA_CORTE."' , '".$T_FECHA_LIMITE."' , '".$T_NIP."' , '".$T_USUARIO."' , '".$T_CONTRASENA."' , '".$T_TELEFONO_EXTRAVIO."' , '".$T_DIRECCION_COMPLETA."' , '".$T_TELEFONO_TARJETA."' , '".$T_CORREO_ALTA."' , '".$T_FECHA_BAJA."' , '".$T_NUMERO_REPORTE."' , '".$T_NOMBRE_OPERADOR."' , '".$T_OBSERVACIONES_1."' , '".$T_OBSERVACIONES_2."' , '".$session."' );  ";			

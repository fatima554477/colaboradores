...
$iTempresarial = isset($_POST["iTempresarial"])?$_POST["iTempresarial"]:""; 
$IpTEMPRESARIAL = isset($_POST["IpTEMPRESARIAL"])?$_POST["IpTEMPRESARIAL"]:""; 
/*if($FECHA_ENTREGA_TARJETA =="" or $FECHA_DEVOLUCION_TARJETA =="" or $TTARJETA =="" or $TBANCO =="" or $T_TIPO_TARJETA =="" or $T_NUMERO_TARJETA =="" or $T_FECHA_VENCIMIENTO =="" or $T_CODIGO_SEGURIDAD =="" or $T_LIMITE_CREDITO =="" or $T_FECHA_CORTE =="" or $T_FECHA_LIMITE =="" or $T_NIP =="" or $T_USUARIO =="" or $T_CONTRASENA =="" or $T_TELEFONO_EXTRAVIO =="" or $T_DIRECCION_COMPLETA =="" or $T_TELEFONO_TARJETA =="" or $T_CORREO_ALTA =="" or $T_FECHA_BAJA =="" or $T_NUMERO_REPORTE =="" or $T_NOMBRE_OPERADOR =="" or $T_OBSERVACIONES_1 =="" or $T_OBSERVACIONES_2 =="" ){*/

	//echo "<P style='color:red; font-size:18px;'>FAVOR DE LLENAR TODOS LOS CAMPOS EN ROJO</p>";	
	
//}else{

echo $conexion->guardarTempresarial ( $FECHA_ENTREGA_TARJETA , $FECHA_DEVOLUCION_TARJETA , $TTARJETA , $TBANCO , $T_TIPO_TARJETA , $T_NUMERO_TARJETA , $T_FECHA_VENCIMIENTO , $T_CODIGO_SEGURIDAD , $T_LIMITE_CREDITO , $T_FECHA_CORTE , $T_FECHA_LIMITE , $T_NIP , $T_USUARIO , $T_CONTRASENA , $T_TELEFONO_EXTRAVIO , $T_DIRECCION_COMPLETA , $T_TELEFONO_TARJETA , $T_CORREO_ALTA , $T_FECHA_BAJA , $T_NUMERO_REPORTE , $T_NOMBRE_OPERADOR , $T_OBSERVACIONES_1 , $T_OBSERVACIONES_2, $ITEMPRESARIAL2,$IpTEMPRESARIAL );
//}
